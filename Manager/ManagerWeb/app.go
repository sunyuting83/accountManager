...
const RootURL = "http://localhost:13005/admin/api/v1/"
...
func (a *App) GetUserWithKey(params map[string]interface{}) map[string]interface{} {
	data := HTTPRequest("GET", "GetUserWithKey", params)
	return data
}
func (a *App) SendCoinToUser(params map[string]interface{}) map[string]interface{} {
	data := HTTPRequest("POST", "SendCoinToUser", params)
	return data
}
...
func (a *App) Login(params map[string]interface{}) map[string]interface{} {
	data := HTTPRequest("POST", "AdminLogin", params)
